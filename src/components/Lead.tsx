...
const TAGLI: TaglioOption[] = [
  { value: 'bilocale', num: '01', name: <span className="ital">Bilocale</span> },
  { value: 'trilocale', num: '02', name: <span className="ital">Trilocale</span> },
  { value: 'quadrilocale', num: '03', name: <span className="ital">Quadrilocale</span> },
  { value: 'attico', num: '04', name: <span className="ital">Attico</span> },
]
...
export default function Lead() {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem('edel_request_capitolato') === 'true') {
    ...
    window.addEventListener('edel:request-capitolato', handler)
    return () => window.removeEventListener('edel:request-capitolato', handler)
  }, [])
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      source: capitoloRequested ? 'landing_edel_capitolato' : 'landing_edel',
      ...
      <div className="lead-inner">
        {capitoloRequested && !success && (
          <div className="lead-banner reveal">
            <span className="lead-banner__tag">Capitolato Edel · Su misura</span>
            <p>
              Lascia nome, telefono ed email. <strong>Quindici minuti al telefono</strong> con Giuseppe Rinaldi (il costruttore) o Massimo Brissoni (l'agenzia REMAX) per conoscerci. Poi ti invieremo il capitolato completo, già adattato alle tue esigenze.
            </p>
          </div>
        )}
        <div className="reveal">
          <div className="eyebrow">{capitoloRequested ? 'Capitolato Edel' : 'Richiedi Informazioni'}</div>
          ...
          <p className="lead-sub">
            {capitoloRequested
              ? 'Quindici minuti al telefono per conoscerci. Poi Giuseppe (il costruttore) o Massimo (l\'agenzia REMAX) ti mandano il capitolato completo — quaranta pagine di scelte tecniche, calibrate sul tuo interesse.'
        ...
        {success && (
          <div className="success show">
            ...
            <p>Ti contatteremo entro 24 ore lavorative con la brochure completa e tutti i dettagli su EDEL.</p>
            ...
            <div className="success-next">
              ...
              <ul>
                <li>
                  <a
                    href="https://wa.me/393332895941?text=Ciao%2C%20vorrei%20info%20su%20EDEL%20Ponteranica"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://maps.google.com/?q=Via+4+Novembre+Ponteranica+Bergamo"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Vedi la posizione
